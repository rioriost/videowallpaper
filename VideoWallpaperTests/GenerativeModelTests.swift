...
struct GenerativeModelTests {
    ...
    @Test func displayWallpaperAssignmentStoreRoundTripsThroughUserDefaults() throws {
        let suiteName = "VideoWallpaperTests-\(UUID().uuidString)"
    ...
    @Test func projectFileStoreSavesAndLoadsProject() throws {
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("VideoWallpaperProject-\(UUID().uuidString)")
    ...
    @Test func exporterCreatesMovieFile() async throws {
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("VideoWallpaperExporterTest-\(UUID().uuidString).mp4")
        defer {
    ...
    @Test func exporterCreatesOrbitalMovieFile() async throws {
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("VideoWallpaperOrbitalExporterTest-\(UUID().uuidString).mp4")
        defer {
            try? FileManager.default.removeItem(at: outputURL)
        }
    ...
    @Test func exporterCreatesSoftVolumetricMovieFile() async throws {
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("VideoWallpaperSoftVolumetricExporterTest-\(UUID().uuidString).mp4")
        defer {
            try? FileManager.default.removeItem(at: outputURL)
        }
    ...
    @Test func exporterCreatesGridCityMovieFile() async throws {
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("VideoWallpaperGridCityExporterTest-\(UUID().uuidString).mp4")
        defer {
            try? FileManager.default.removeItem(at: outputURL)
        }
    ...
    @Test func exporterHonorsCancellation() async throws {
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("VideoWallpaperExporterCancellationTest-\(UUID().uuidString).mp4")
        defer {
            try? FileManager.default.removeItem(at: outputURL)
        }
